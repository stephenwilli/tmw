...
if ( ! class_exists( 'Tribe__Events__Pro__Main' ) ) {
	class Tribe__Events__Pro__Main {
		...
		public function admin_enqueue_scripts() {
			...
			wp_enqueue_script( Tribe__Events__Main::POSTTYPE . '-premium-recurrence', tribe_events_pro_resource_url( 'events-recurrence.js' ), array( Tribe__Events__Main::POSTTYPE.'-premium-admin', 'handlebars', 'moment', 'tribe-dropdowns', 'jquery-ui-dialog' ), apply_filters( 'tribe_events_pro_js_version', self::VERSION ), true );
