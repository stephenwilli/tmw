...
<tr class="recurrence-row tribe-datetime-block">
	...
	<td>
		...
		<script type="text/x-handlebars-template" id="tmpl-tribe-recurrence">
			<div class="tribe-event-recurrence tribe-event-recurrence-rule">
				...
				<select
					...
					class="tribe-recurrence-rule-type tribe-dropdown"
					data-hide-search
					data-prevent-clear
					data-field="type"
					data-single="<?php esc_attr_e( 'event', 'tribe-events-calendar-pro' ) ?>"
					data-plural="<?php esc_attr_e( 'events', 'tribe-events-calendar-pro' ) ?>"
					data-placeholder="<?php esc_attr_e( 'Add event(s)', 'tribe-events-calendar-pro' ); ?>"
				>
					{{#tribe_recurrence_select custom.type}}
						<option value=""></option>
						<option value="Date"><?php esc_html_e( 'A single event', 'tribe-events-calendar-pro' ); ?></option>
						<option value="Daily" data-singular="<?php esc_attr_e( 'day', 'tribe-events-calendar-pro' ); ?>"><?php esc_html_e( 'Daily', 'tribe-events-calendar-pro' ); ?></option>
						<option value="Weekly"><?php esc_html_e( 'Weekly', 'tribe-events-calendar-pro' ); ?></option>
						<option value="Monthly"><?php esc_html_e( 'Monthly', 'tribe-events-calendar-pro' ); ?></option>
						<option value="Yearly"><?php esc_html_e( 'Yearly', 'tribe-events-calendar-pro' ); ?></option>
					{{/tribe_recurrence_select}}
				</select>
				<span class="tribe-dependent" data-depends="#recurrence_rule_--_type" data-condition-not-empty>
					<span class="tribe-dependent recurrence-custom-container" data-depends="#recurrence_rule_--_type" data-condition="Date">
						<span class="tribe-field-inline-text"><?php esc_html_e( 'that will occur on', 'tribe-events-calendar-pro' ); ?></span>
					</span>
					<span class="tribe-dependent" data-depends="#recurrence_rule_--_type" data-condition-not="Date">
						...
						<span class="tribe-field-inline-text tribe-dependent" data-depends="#recurrence_rule_--_type" data-condition="Yearly">
							<span class="tribe-dependent" data-depends="#recurrence_rule_--_interval" data-condition="1">
		...
		<button id="tribe-add-recurrence" class="button">
	...
	<td>
		...
		<script type="text/x-handlebars-template" id="tmpl-tribe-exclusion">
			<div class="tribe-event-exclusion tribe-event-recurrence-exclusion">
				...
				>
					{{#tribe_recurrence_select custom.type}}
					<option value=""><?php esc_html_e( 'no exclusion', 'tribe-events-calendar-pro' ); ?></option>
					<option value="Date"><?php esc_html_e( 'on date', 'tribe-events-calendar-pro' ); ?></option>
					<option value="Daily" data-singular="<?php esc_attr_e( 'daily', 'tribe-events-calendar-pro' ); ?>"><?php esc_html_e( 'daily', 'tribe-events-calendar-pro' ); ?></option>
					<option value="Weekly"><?php esc_html_e( 'weekly', 'tribe-events-calendar-pro' ); ?></option>
					<option value="Monthly"><?php esc_html_e( 'monthly', 'tribe-events-calendar-pro' ); ?></option>
					<option value="Yearly"><?php esc_html_e( 'yearly', 'tribe-events-calendar-pro' ); ?></option>
					{{/tribe_recurrence_select}}
				</select>
				<span class="tribe-dependent" data-depends="#exclusion_rule_--_type" data-condition-not-empty>
					<span class="tribe-dependent recurrence-custom-container" data-depends="#exclusion_rule_--_type" data-condition="Date"></span>
					<span class="tribe-dependent" data-depends="#exclusion_rule_--_type" data-condition-not="Date">
						...
						<span class="tribe-field-inline-text tribe-dependent" data-depends="#exclusion_rule_--_type" data-condition="Yearly">
							<span class="tribe-dependent" data-depends="#exclusion_rule_--_interval" data-condition="1">
								<?php esc_html_e( 'year', 'tribe-events-calendar-pro' ); ?>
							</span>
							<span class="tribe-dependent" data-depends="#exclusion_rule_--_interval" data-condition-not="1">
				...
				<div class="tribe-recurrence-details">
					<div class="tribe-dependent" data-depends="#exclusion_rule_--_type" data-condition="Weekly">
						<?php
						/**
						 * Filters the week template for the recurrence UI
						 *
					...
					<div class="tribe-dependent" data-depends="#exclusion_rule_--_type" data-condition="Monthly">
						<?php
						/**
						 * Filters the month template for the recurrence UI
						 *
